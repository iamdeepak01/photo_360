package com.visticsolution.posterbanao.editor.utility;
...
public class ImageUtils {
    ...
    public static Bitmap getResampleImageBitmap(Uri uri, Context context, int i) throws IOException {
        try {
            return com.visticsolution.posterbanao.editor.utils.ImageUtils.getInstant().getCompressedBitmap(getRealPathFromURI(uri, context));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
