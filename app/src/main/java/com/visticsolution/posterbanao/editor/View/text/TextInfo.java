package com.visticsolution.posterbanao.editor.View.text;
...
public class TextInfo {
    ...
    public TextInfo(String str, String str2, int i2, int i3, int i4, int i5, String str3, int i6, int i7, float f, float f2, int i8, int i9, float f3, String str4, int i10, int i11, int i12, int i13, int i14, int i15, String str5, String str6, String str7, float f4, float f5, int i16, int i17,String weight,String justification) {
        this.TEXT = str;
        this.FONT_NAME = str2;
        this.TEXT_COLOR = i2;
        this.TEXT_ALPHA = i3;
